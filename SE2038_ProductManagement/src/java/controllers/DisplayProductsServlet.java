...
public class DisplayProductsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DisplayProductsServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DisplayProductsServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String strCat = request.getParameter("ddCat");
            ProductDao prdDao = new ProductDao();
            List<Product> prdList = new ArrayList<>();

            prdList = prdDao.searchProductsByName(strKw, strCat);
            request.setAttribute("prdList", prdList);
